...
class MenuAppTestCase(unittest.TestCase):
    ...
    def test_static_assets_are_cache_busted(self):
        ...
        self.assertIn(b'<nav class="host-tabs" aria-label="Host navigation">', response.data)
        ...
        self.assertIn(".host-tabs {", stylesheet)
        self.assertIn(".host-tab.active", stylesheet)
        self.assertIn(".host-utility-actions", stylesheet)
